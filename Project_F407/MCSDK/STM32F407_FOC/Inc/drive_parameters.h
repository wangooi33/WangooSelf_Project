...
#define PID_TORQUE_KI_DEFAULT               814
#define PID_TORQUE_KD_DEFAULT               100
#define PID_FLUX_KP_DEFAULT                 2816
#define PID_FLUX_KI_DEFAULT                 814
...
#define PID_SPEED_KP_DEFAULT                3842/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT                280/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define UD_VOLTAGE_THRESHOLD_V              12.0 /*!< Under-voltage threshold */
