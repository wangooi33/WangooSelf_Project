...
#define M1_CURR_AMPL_U_GPIO_Port GPIOF
#define M1_CURR_AMPL_V_Pin GPIO_PIN_7
#define M1_CURR_AMPL_V_GPIO_Port GPIOF
#define M1_CURR_AMPL_W_Pin GPIO_PIN_8
#define M1_CURR_AMPL_W_GPIO_Port GPIOF
#define M1_BUS_VOLTAGE_Pin GPIO_PIN_9
#define M1_BUS_VOLTAGE_GPIO_Port GPIOF
